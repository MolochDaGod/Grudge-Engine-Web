...
import { Play, Pause, Settings, Map, Layers, Bug, ExternalLink, ChevronDown, ChevronRight, Monitor, Maximize2, RefreshCw } from 'lucide-react';
...
import { sceneRegistry, type RPGSceneConfig } from '@/lib/scenes/scene-registry';
...
export function AdminPanel({ isVisible, onClose, onSceneChange, currentSceneId }: AdminPanelProps) {
        ...
        <div className="p-2 space-y-2">
          ...
          >
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                <Label className="text-xs">Show Colliders</Label>
                <Switch data-testid="switch-colliders" />
              </div>
              <div className="flex items-center justify-between">
