...
export const GRUDGE_RACES: Record<RaceId, GrudgeRace> = {
  ...
  orc: {
    ...
    availableClasses: ['warrior', 'worge'],
    themeColor: '#6b8c3d',
    borderColor: '#7da050',
  },
  undead: {
    ...
    availableClasses: ['mage', 'warrior', 'worge'],
    themeColor: '#5c4e6e',
    borderColor: '#7060a0',
  },
  barbarian: {
